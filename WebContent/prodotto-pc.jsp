...
Collection<PostazioneBean> prodotti = model.doRetrieveByType("PC");
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="DettagliPostazione?tipo=pc&n_posto=<%=item.getN_posto()%>"><img src="./getPicturePostazione?n_posto=<%= item.getN_posto() %>" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="DettagliPostazione?tipo=pc&n_posto=<%=item.getN_posto()%>"><%=item.getNome_postazione()%></a></h3>
                    <p class="mb-0"><%=item.getDescrizione()%></p>
                    <p class="text-primary font-weight-bold"><%=item.getCosto()%></p>
                  </div>
                </div>
              </div>
            </div>
